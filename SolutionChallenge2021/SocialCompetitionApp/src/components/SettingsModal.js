    ...
    return (
        <View style={uStyles.modal}>
            ...
            <ScrollView>
                ...
                <Text style={[uStyles.body, {color: colors.black, marginLeft: 36, fontWeight: "normal", marginTop: 36}]}>
                    {'\u00A9'} 2021 by Team Salsa{'\n\n'}
                    Rohan Agarwal, Hane Yie,{'\n'}Aritro Basu, & Daniel Yuan{'\n\n'}
                    Google DSC @ Georgia Tech
                </Text>
            </ScrollView>
        </View>
    );
